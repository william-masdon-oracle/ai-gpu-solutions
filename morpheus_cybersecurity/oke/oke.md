...
1. You will begin by creating the stack to run the automation code in the OCI ORM.
    ...
    * Choose _My configuration_, upload this [Morpheus automation stack](https://github.com/bogdanbazarca/orm_morpheus_fraud_detection_oke) and click **Next**.
    ...
    * You can use the single click deployment button below to launch the stack creation directly, accept the temrs and click **Next**.
    ...
    [![Deploy to Oracle Cloud](https://oci-resourcemanager-plugin.plugins.oci.oraclecloud.com/latest/deploy-to-oracle-cloud.svg)](https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/bogdanbazarca/orm_morpheus_fraud_detection_oke/archive/refs/heads/main.zip)
